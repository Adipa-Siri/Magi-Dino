...
public:
	...
	void flip();
	static Enemy* newEnemy(int damage, const std::string file, float duration, float speed, float width, float length, float x, float y, sf::Vector2f pos, Player* player, int health);
